...
const underProgressResponse = await axios.get(`http://localhost:5000/hr-statistics/?status=under-progress&hrId=${HrId}`);
const level1Response = await axios.get(`http://localhost:5000/hr-statistics/?status=level-1&hrId=${HrId}`);
const level2Response = await axios.get(`http://localhost:5000/hr-statistics/?status=level-2&hrId=${HrId}`);
const level3Response = await axios.get(`http://localhost:5000/hr-statistics/?status=level-3&hrId=${HrId}`); 
