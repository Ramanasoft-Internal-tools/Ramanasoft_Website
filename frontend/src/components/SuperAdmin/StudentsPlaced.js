...
const SAStudentsPlaced = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/sa-job-applicants/?status=${status}`); // Adjust the URL as needed
...
export default SAStudentsPlaced;
